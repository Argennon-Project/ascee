...
Modifier ChunkIndex::buildModifier(const AppRequestRawData::AccessMapType& rawAccessMap) {
    vector<heap::Modifier::ChunkMap64> chunkMapList;
    ...
    for (long i = 0; i < rawAccessMap.size(); ++i) {
        ...
        vector<heap::Modifier::ChunkInfo> chunkInfoList;
